...
import me.saro.commons.bytes.FixedDataConverter;
...
//    }
    ...
    public void inClass() {
        ...
        //ParentStruct ms = new ParentStruct(1, new ChildStruct(2, "단일"), new ChildStruct[] {new ChildStruct(32, "배열1"), new ChildStruct(81, "배열2")});
        ParentStruct ms = new ParentStruct(1, new ChildStruct(2, "단일"));
    ...
    public static class ParentStruct {
        ...
        @FixedBinary(offset=4)
        ChildStruct ch;
        
        @FixedBinary(offset=18, arrayLength=2)
        ChildStruct[] chArr;
    }
